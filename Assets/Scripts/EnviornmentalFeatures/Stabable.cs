...
public class Stabable : MonoBehaviour
{
    ...
    private void OnDrawGizmos()
    {
        ...
        Gizmos.DrawRay(dashStartTransform.localPosition, direction);
        ...
        Gizmos.DrawRay(dashStartTransform.localPosition + direction, rightHandle * handleLength);
        Gizmos.DrawRay(dashStartTransform.localPosition + direction, leftHandle * handleLength);
